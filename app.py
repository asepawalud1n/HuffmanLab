"""
Flask Web Application for Image Compression using Huffman Coding
================================================================
Aplikasi web untuk kompresi citra menggunakan algoritma Huffman Coding

Features:
- Single image compression
- Batch dataset compression
- Decompression
